...
Citizen.CreateThread(function()
     for k in pairs(position) do
        ...
        AddTextComponentString("Location d'hélicoptère")
...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('hs0_heliclocation', 'main'), true, true, true, function()
            ...
            RageUI.Button("Frogger", nil, {RightLabel = "~g~50000$"},true, function(Hovered, Active, Selected)
            if (Selected) then   
            ...
            RageUI.Button("Maverick", nil, {RightLabel = "~g~25000$"},true, function(Hovered, Active, Selected)
            if (Selected) then   
